...
const interfaceDescriptions: Record<string, MessageKey> = {
  ...
  '/plugins/download_rank': 'traffic.route./plugins/download_rank',
  '/plugins/download_trend': 'traffic.route./plugins/download_trend',
  '/plugins/rank': 'traffic.route./plugins/rank',
